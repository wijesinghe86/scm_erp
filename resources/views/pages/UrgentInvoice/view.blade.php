    ...
    <div class="content-wrapper">
        <div class="row">
            <div class="col-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <div class="card-title">Urgent Invoice {{ $invoices->invoice_number }}</div>
                        <table class="table" style="width: 100%;min-height: 25mm;height: 25mm;margin:0px; padding:0;">
                                ...
                                <td class="border" rowspan="3">
                                    <div style="display: flex; gap:10px;">
                                        ...
                                        <div>
                                            ...
                                            <small>{{ $invoices->get_customer->customer_address_line1 }}</small><br>
                                            <small>{{ $invoices->get_customer->customer_address_line1 }}</small><br>
                                            <small>{{ $invoices->get_customer->customer_mobile_number }}</small><br>
                                            <small>{{ $invoices->get_customer->customer_email }}</small><br>
                                        </div>
                                    </div>
                                </td>
                                <td class="info-td border" style="height: 8mm">
                                    <small>Vat No : {{ $invoices->get_customer->customer_vat_number }}</small>
                                </td>
                                <td class="info-td border" style="height: 8mm">
                            ...
                            <tr>
                                <td class="info-td border" style="height: 8mm">
                                    <small>Terms : {{ $invoices->getPaymentTerm() }} {{ $invoices->payment_term }}</small>
                                </td>
                                    ...
                                    <table>
                                        ...
                                        @foreach ($invoices->items as $key => $item)
                                            <tr class="border">
                                                ...
                                                <td align="right" class="border"
                                                    style="height: 6mm;min-height:6mm; max-height:6mm; width: 11mm;padding:0 10px">
                                                    {{ money($item->item_discount_value) }}</td>
                                                <td align="right" class="border"
                                                    style="height: 6mm;min-height:6mm; max-height:6mm; width: 11mm;padding:0 10px">
                                                    {{ money($item->item_value) }}</td>
                                            </tr>
                                        @endforeach
                                        <tr>
                                            <td colspan="6"></td>
                        ...
                        <div style="display: flex;justify-content: flex-end; align-items: center; margin: 20px 0">
                            <a target="_blank" href="{{ route('urgent_invoice.print', ['urgent_invoice_id' => $invoices->id]) }}"
                                class="btn btn-secondary mr-5"> Print</a>
                            <a href="{{ route('urgent_invoice.index') }}" class="btn btn-primary"> Previous</a>
                        </div>
