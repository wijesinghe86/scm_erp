                    ...
                    <div class="card-body">
                        ...
                        @if (!$invoice_return->is_approved)
                            <form class="row form-group" method="POST"
                                action="{{ route('distributor_returns.approval', $invoice_return->id) }}">
                                @csrf
                        ...
                        <br>
                        <a href="{{ route('distributor_returns.index') }}">
                            <button class="btn btn-success">Back</button>
                        </a>
                        <a href="{{ route('distributor_returns.print' ,['return_id'=> $invoice_return->id]) }}">
