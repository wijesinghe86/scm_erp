    ...
    <div class="content-wrapper">
        <div class="row">
            <div class="col-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <h4 class="title"> New Customer Return Entry</h4>
                        <br>
                        <form id="customerReturn" action="{{ route('distributor_returns.store') }}" method="POST">
                        @csrf
                        <div class="row">
...
@push('scripts')
    <script>
        ...
        function onSubmit() {
            ...
            $.ajax({
                url: "{{ route('distributor_returns.store') }}",
                headers: {
        ...
        $("#customer_id").change(function() {
            ...
            window.location.href =
                `/distributor_returns/create?customer_id=${customerId}&invoice_date=${invoiceDate}&invoice_number=${invoiceNumber}&delivery_order_no=${deliveryOrderId}`
        });
