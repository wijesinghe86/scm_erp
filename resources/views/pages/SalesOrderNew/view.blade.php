                        ...
                        <h4 class="card-title"><a href="{{ route('dashboard') }}" ><i class="mdi mdi-home"></i></a>Invoice No: {{ $invoices->invoice_number }}</h2>
                            <br>
                             ...
                             <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                <a href="{{ route('sales_order_new.index') }}" class="btn btn-success mb-2 float-end mb-2"> Back</a>
                            </div>
                            <table class="table table-bordered" id="invoices-table">
                             ...
                             {{-- <div style="display: flex;justify-content: flex-end; align-items: center; margin: 20px 0"> --}}
                                {{-- <a target="_blank" href="{{ route('sales_order_new.print', ['invoice_id' => $invoices->id]) }}" class="btn btn-success mb-2 float-end mb-2"> Print</a>  --}}
                                <div style="display: flex;justify-content: flex-end; align-items: center; margin: 20px 0">
                                    <a target="_blank" href="{{ route('sales_order_new.print', ['invoice_id' => $invoices->id]) }}"
