                        ...
                        <h4 class="card-title"><a href="{{ route('dashboard') }}" ><i class="mdi mdi-home"></i></a>Sales Order Registry</h2>
                            ...
                            <form action="" class="row">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <a href="{{ route('sales_order_new.index') }}">
                            ...
                            {{-- <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                <a href="{{ route('distributor_invoices.create') }}" class="btn btn-success mb-2 float-end mb-2"> Add new </a>
                            </div> --}}
                                ...
                                <tbody>
                                    @foreach ($invoices as $invoice)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('sales_order_new.view', $invoice->id) }}">
