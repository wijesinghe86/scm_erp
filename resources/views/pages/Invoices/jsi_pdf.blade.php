  ...
  {{-- header --}}
    ...
    <table style="height: 25mm">
     {{-- invoice to  --}}
        <tr>
            <td rowspan="3">
                <div style="font-size: 16px; margin-left: 10mm;">
                    ...
                    {{ $invoices->customer->customer_vat_number }}<br>
                </div>
            </td>
        ...
        <tr>
            <td style="height: 16mm; width:19mm; opacity: 0;">Terms</td>
            <td style="height: 16mm; width:24mm; text-align:center;">{{ $invoices->payment_terms }} {{ $invoices->credit_days }}</td>
