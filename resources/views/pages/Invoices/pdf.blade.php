  ...
  {{-- header --}}
    ...
    <table style="height: 25mm">
        ...
        <tr>
            ...
            <td style="height: 8mm; width:32mm">Vat No</td>
        ...
        <tr>
            <td style="height: 8mm; width:32mm; opacity: 0;">Terms</td>
        ...
        <tr>
            <td style="height: 8mm; width:32mm; opacity:0;">Purchanse Order No.</td>
