    ...
    <div class="content-wrapper">
        <div class="row">
            <div class="col-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <h4><a href="{{ route('dashboard') }}"><i class="mdi mdi-home"></i></a>Stock Location Change Received
                            List</h2>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="btn btn-primary"
                                                        href="{{ route('stocklocationchange_received.create', $stock_location_change->id) }}">View</a>
                                                </td>
