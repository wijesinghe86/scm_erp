...
<div class="content-wrapper">
    <div class="row">
        <div class="col-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <h3 style="color: grey" class="title">New Invoice</h4>
                        <br>
                        <br>
                        <form id="invoiceCreateForm" action="{{ route('distributor_invoices.store') }}" method="POST">
                            @csrf
                            <div style="position: relative;">
                                ...
                                <h4 style="color: grey" class="title">Organization Information</h4>
                                <br>
                                <br>
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-2">
                                        ...
                                        <input type="text" class="form-control" id="organization_code" name="organization_code"
                                            placeholder="organization_code" disabled>
                                    </div>
                                    <div class="form-group col-md-2">
                                        <label>TIN No</label>
                                        <input type="text" class="form-control" id="organization_tin_no" name="organization_tin_no"
                                            placeholder="organization_tin_no" disabled>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-md-5">
                                        <label>Address 1</label>
                                        <input type="text" class="form-control" id="organization_address_line1" name="organization_address_line1"
                                            placeholder="organization_address_line1" disabled>
                                    </div>
                                    <div class="form-group col-md-5">
                                        <label>Address 2</label>
                                        <input type="text" class="form-control" id="organization_address_line2" name="organization_address_line2"
                                            placeholder="organization_address_line2" disabled>
                                    </div>
                                    <div class="form-group col-md-2">
                                        <label>Telephone No</label>
                                        <input type="text" class="form-control" id="organization_telephone_number" name="organization_telephone_number"
                                            placeholder="organization_telephone_number" disabled>
                                    </div>
                                </div>
                                <hr>
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-2">
                                        ...
                                        <select class="form-control" name="invoice_category" readonly id="invoice_category" style="display: none;"
                                            required>
                                            <option value="">-</option>
                                    ...
                                    <div class="form-group col-md-2">
                                        <label style="display: none;">Invoice Option</label>
                                        <select class="form-control" name="invoice_option" id="invoice_option" style="display: none;">
                                            <option value="">Select</option>
                ...
                <div class="row">
                    <div class="form-group col-md-8">
                        ...
                        <input type="text" class="form-control "
                            value="" name="grand_total_inword" id="grand_total_inword">
                    </div>
                </div>
                <div class="row">
                    <div class="form-group col-md-12">
                        ...
                        <input type="text" class="form-control" id="additional_info"
                            name="additional_information" placeholder="additional_information">
                    </div>
...
<script>
    ...
    $('#invoice_category').on('change', function() {
        ...
        $.ajax({
            url: "{{ route('distributor_invoices.get.number') }}",
            headers: {
    ...
    function fetchInvoiceTotal() {
        let paymentTerm = $("#payment_terms").val()
        $.ajax({
            url: "{{ route('distributor_invoices.get.total') }}",
            headers: {
                'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
            },
            type: "GET",
            ...
            success: function(response) {
                ...
                let total = parseFloat(response.grandTotal || 0).toFixed(2);
    ...
    function getOrganization() {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                $('#organization_address_line2').val(response.organization_address_line2);
                $('#organization_telephone_number').val(response.organization_phone_number);
    ...
    function addInvoiceItem(invoice_no) {
        ...
        $.ajax({
            url: "{{ route('distributor_invoices.item.store') }}",
            headers: {
                'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
            },
            type: "POST",
    ...
    function getItemsTable() {
        $.ajax({
            url: "{{ route('distributor_invoices.item.table') }}",
            headers: {
                'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
            },
            type: "GET",
