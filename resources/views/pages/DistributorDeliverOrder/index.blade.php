                                ...
                                <div class ="container">
                                    <div class="row m-2">
                                        <form action="" class="col-9">
                                            ...
                                            <a href="{{ route('distributor_deliveryorders.index') }}">
                                                ...
                                                <tbody id="invoices-table">
                                                    @foreach ($deliveryOrders as $key => $deliveryOrder)
                                                        <tr>
                                                            ...
                                                            <td align="center">
                                                                <a class="h4"
                                                                    href="{{ route('distributor_deliveryorders.view', $deliveryOrder->id) }}">
                                                                    <i class="fa-sharp fa-solid fa-eye"></i>
                                                                </a>
                                                            </a>
                                                            </td>
                                                            <td align="center">
                                                            <a href="{{ route('distributor_deliveryorders.cancel', $deliveryOrder->id) }}">
