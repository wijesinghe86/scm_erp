                ...
                <div class="card">
                    <div class="card-header">
                        <div class="header">
                            ...
                            <div class="card-body">
                                <div class="content">
                                    ...
                                    <div class="col-md-4" style="margin-bottom:20px;">
                                        <a href="{{ route('distributor_deliveryorders.issueIndex', $delivery_order->id) }}"
                            ...
                            <a target="_blank" href="{{ route('distributor_deliveryorders.print', ['delivery_order_id' => $delivery_order->id]) }}"
                               type="submit" class="btn btn-secondary mr-5" name="button"> Print</a>
                            <a class="btn btn-danger" href="{{route('distributor_deliveryorders.index')}}" >D/O Registry</a>
                        </div>
                    </div>
                </div>
            </div>
