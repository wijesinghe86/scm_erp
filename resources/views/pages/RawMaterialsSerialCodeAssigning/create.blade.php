            ...
            <div class="col-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="forms-sample" method="POST" action="{{ route('rawmaterialsserialcodeassigning.store') }}">
                            @csrf
                            <div class="row">
                                <div class="form-group col-md-4">
                                    <label>Date</label>
                                    <input type="date" class="form-control" name="entry_date" placeholder="entry_date">
                                </div>
                                <div class="form-group col-md-4">
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <form class="forms-sample ajax-form"  method="POST" action="{{ route('raw_material_code_assign.store') }}">
