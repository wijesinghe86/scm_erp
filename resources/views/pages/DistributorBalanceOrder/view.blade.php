        ...
        <div class="row">
            <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                    ...
                    <div class="card-body ">
                        ...
                        @if (!$balance_order->is_issued)
                            <div class="col-md-4" style="margin-bottom:20px;">
                                <a href="{{ route('distributor_balanceOrder.delivery_order_create_index', $balance_order->id) }}"
                    ...
                    <div class="col-md-4">
                        <a target="_blank"
                            href="{{ route('distributor_balanceOrder.print', ['balance_order_id' => $balance_order->id]) }}"
