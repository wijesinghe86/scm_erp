        ...
        <tbody>
            @foreach ($items as $index => $item)
                <tr>
                    ...
                    <td>{{ $item->remarks }}</td>
                    <td>
                        <input readonly style="width: 10rem" type="number" value="{{ $item->semi_product_qty }}" required class="form-control"
                    ...
                    <td>
                        <input style="width: 10rem" type="text" class="form-control" name="items[{{ $index }}][remarks]" />
                    </td>
                </tr>
            @endforeach
        </tbody>
