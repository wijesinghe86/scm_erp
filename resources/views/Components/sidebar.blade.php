    ...
    <ul class="nav">
            ...
            <div class="collapse" id="ui-master">
                ...
                <li class="nav-item"> <a class="nav-link"
                    ...
                    <li class="nav-item"> <a class="nav-link" href="{{ route('locationbaydesign.index') }}">Location Bay
                            Design</a></li>
                    <li class="nav-item"> <a class="nav-link" href="{{ route('locationrowdesign.index') }}">Location Row
                            Design</a></li>
            ...
            <div class="collapse" id="ui-sale">
                <ul class="nav flex-column sub-menu">
                    ...
                    <li class="nav-item"> <a class="nav-link" href="{{ route('balanceorder.index') }}">Balance
                        Order</a></li>
                <li class="nav-item"> <a class="nav-link" href="{{ route('returns.all') }}">Return</a></li></li>
                <li class="nav-item"> <a class="nav-link" href="{{ route('returns.approvalIndex') }}">Return Approval</a></li></li>
                </ul>
            </div>
        </li>
        ...
        <li class="nav-item">
            ...
            <div class="collapse" id="ui-plan">
                <ul class="nav flex-column sub-menu">
                    <li class="nav-item"> <a class="nav-link"
                            href="{{ route('warehouseareadesign.index') }}">Warehouse Area Design</a></li>
        ...
        <li class="nav-item">
            ...
            <div class="collapse" id="ui-safe">
                <ul class="nav flex-column sub-menu">
                    ...
                    <li class="nav-item"> <a class="nav-link"
                            href="{{ route('equipmentmaintenance.index') }}">Equipment Maintenance</a></li>
                </ul>
            </div>
        </li>
            ...
            <div class="collapse" id="ui-pps">
                <ul class="nav flex-column sub-menu">
                    ...
                    <li class="nav-item"> <a class="nav-link"
                            ...
                            Machanism <br>Production And Time <br>Management</a></li>
                    <li class="nav-item"> <a class="nav-link"
                            href="{{ route('planttimemanagement.index') }}">Customer Relationship
                            Time Management</a></li>
                    <li class="nav-item"> <a class="nav-link"
            ...
            <div class="collapse" id="ui-pps">
                <ul class="nav flex-column sub-menu">
                    ...
                    <li class="nav-item"> <a class="nav-link"
                            ...
                            Machanism <br>Production And Time <br>Management</a></li>
                    <li class="nav-item"> <a class="nav-link"
                            href="{{ route('planttimemanagement.index') }}">Supplier Relationship
                            Time Management</a></li>
                    <li class="nav-item"> <a class="nav-link"
        ...
        <li class="nav-item">
            ...
            <div class="collapse" id="ui-pps">
                <ul class="nav flex-column sub-menu">
                    ...
                    <li class="nav-item"> <a class="nav-link"
                            href="{{ route('semiproduction.index') }}">Department-wise Demand<br>Forecasted Stock
                            Items
                        </a></li>
                    <li class="nav-item"> <a class="nav-link"
        ...
        <li class="nav-item">
            ...
            <div class="collapse" id="ui-pps">
                <ul class="nav flex-column sub-menu">
                    ...
                    <li class="nav-item"> <a class="nav-link"
                            href="{{ route('productionwastage.index') }}">Date-wise Finished <br>Goods Report </a>
                    </li>
                    ...
                    <li class="nav-item"> <a class="nav-link"
                            href="{{ route('planttimemanagement.index') }}">Monhly Production Report
                        </a></li>
                    <li class="nav-item"> <a class="nav-link"
