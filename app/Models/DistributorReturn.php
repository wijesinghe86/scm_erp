...
class DistributorReturn extends Model
{
    ...
    public function generateReturnOrderNumber()
    {
        ...
        return "MRT" . sprintf('%06d', $return_order_count + 1);
    }

    public function items()
    {
        return $this->hasMany(DistributorReturnItem::class, "return_id", "id");
    }

    
    public function invoice()
    {
        return $this->hasOne(DitributorInvice::class, "id", "invoice_id");
    }
